...
public class AdminRoomController {
    ...
    public CommandResult closeRoom(HttpServletRequest request, HttpServletResponse response) {
    ...
    public CommandResult openRoom(HttpServletRequest request, HttpServletResponse response) {
        Security security = new ManagerOnly();
        if(!security.doSecurity(request, response)){
            return new CommandResult(getAbsoluteUrl("", request), RequestDirection.REDIRECT);
        }
