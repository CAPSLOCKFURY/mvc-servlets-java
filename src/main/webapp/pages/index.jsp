...
<form method="get" class="form-group">
    ...
    <select class="form-select me-2" style="width: 10%" name="orderColName">
    ...
    <select class="form-select me-2" style="width: 10%" name="orderDirection">
    ...
    <button class="btn btn-outline-primary" type="submit"><fmt:message key="sortResults"/></button>
    </div>
</form>
...
<div class="d-flex justify-content-start">
    ...
    <h2 class="text-center"><a href="<c:url value="/project/room">
